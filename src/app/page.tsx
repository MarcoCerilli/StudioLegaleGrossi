...
export default function Home() {
  ...
  const services = [
    { title: "Diritto di Famiglia", desc: "Separazioni, divorzi e tutela dei minori con approccio umano e risolutivo.", icon: Users },
    { title: "Diritto Civile", desc: "Consulenza contrattuale, risarcimento danni e controversie civili.", icon: Scale },
    { title: "Diritto del Lavoro", desc: "Assistenza per licenziamenti, mobbing e sicurezza sul lavoro.", icon: Briefcase },
    { title: "Diritto Penale", desc: "Difesa tecnica in procedimenti penali per persone fisiche ed enti.", icon: Gavel },
  ];
          ...
          <div className="container mx-auto px-6 max-w-6xl grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div className="z-10 space-y-8 text-center lg:text-left lg:pr-8">
              ...
              <p className="text-lg md:text-xl text-muted-foreground max-w-lg mx-auto lg:mx-0 font-body leading-relaxed">
                Soluzioni legali concrete e consulenza strategica nel territorio di <strong>Terracina</strong>, guidate da competenza e rigore.
              </p>
              <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start pt-2">
                <Button asChild size="lg" className="bg-primary hover:bg-primary/90 text-white px-8 py-7 text-lg rounded-xl shadow-xl shadow-primary/20 transition-transform hover:scale-105">
                  <Link href="#contatti">Consulenza Legale</Link>
                </Button>
                <Button asChild size="lg" variant="outline" className="border-accent text-accent hover:bg-accent/5 px-8 py-7 text-lg rounded-xl transition-all">
            ...
            <div className="relative z-10 w-full flex justify-center lg:justify-end">
              <div className="relative w-full max-w-[520px] aspect-[4/5] rounded-[2.5rem] overflow-hidden shadow-2xl group">
                <Image src={heroImg?.imageUrl || ""} alt="Avvocato Simona Grossi Terracina" fill className="object-cover transition-transform duration-700 group-hover:scale-105" unoptimized />
        ...
        <section id="servizi" className="py-24 bg-white relative">
          <div className="container mx-auto px-6">
            <div className="text-center max-w-3xl mx-auto mb-16 space-y-4">
              ...
              <p className="font-headline text-4xl font-bold text-primary">Eccellenza Legale e Strategia</p>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
              {services.map((service, i) => (
                <div key={i} className="p-8 rounded-3xl border border-transparent bg-slate-50/50 hover:bg-white hover:shadow-xl transition-all duration-300 group">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
              <div className="relative">
                <div className="aspect-[4/5] relative rounded-[2.5rem] overflow-hidden shadow-2xl">
                  <Image src={aboutImg?.imageUrl || ""} alt="Avvocato Simona Grossi" fill className="object-cover" unoptimized />
                </div>
                <div className="absolute -bottom-8 left-8 bg-white p-6 rounded-2xl shadow-xl border max-w-[240px]">
                  ...
                  <p className="text-xs text-muted-foreground italic">"Ogni caso merita una strategia su misura e un impegno instancabile."</p>
                </div>
              </div>
              <div className="space-y-8">
                <div>
                  <h2 className="text-xs font-bold uppercase tracking-[0.2em] text-accent mb-3">Lo Studio</h2>
                  <h3 className="font-headline text-4xl font-bold text-primary leading-tight">Esperienza e Metodo</h3>
                </div>
                <div className="space-y-6 text-muted-foreground font-body text-lg">
                  <p>L'Avvocato Simona Grossi esercita la professione forense con una visione moderna del diritto, unendo precisione tecnica a una spiccata capacità di problem solving.</p>
                  <p>Lo studio riceve su appuntamento nel territorio di <strong>Terracina</strong>, offrendo assistenza legale sia in ambito giudiziale che stragiudiziale.</p>
                  <ul className="grid grid-cols-1 sm:grid-cols-2 gap-4 pt-4">
                    {["Diritto Civile", "Diritto di Famiglia", "Diritto del Lavoro", "Diritto Penale"].map((item, i) => (
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-16 mb-16">
            <div className="space-y-8">
              ...
              <p className="text-primary-foreground/70 text-lg leading-relaxed max-w-sm">
                Difesa legale d'eccellenza e consulenza strategica. Un approccio moderno e rigoroso al servizio del diritto.
              </p>
            </div>

            <div className="grid grid-cols-2 gap-8">
              <div>
                <h4 className="font-headline font-bold text-sm mb-8 uppercase tracking-widest text-accent">Esplora</h4>
              ...
              <div>
                <h4 className="font-headline font-bold text-sm mb-8 uppercase tracking-widest text-accent">Contatti</h4>
            ...
            <div className="lg:pl-8 space-y-8">
              <h4 className="font-headline font-bold text-sm mb-8 uppercase tracking-widest text-primary-foreground/90">Contatto Diretto</h4>
              <div className="space-y-6">
                <a href="tel:+393500632527" className="group flex items-center gap-5 text-primary-foreground/70 hover:text-white transition-all">
                  ...
                  <div className="flex flex-col">
                    <span className="text-[10px] uppercase tracking-widest font-bold opacity-50">Telefono</span>
                    <span className="text-xl font-bold tracking-tight">+39 350 063 2527</span>
                  </div>
                </a>
                <a href="https://wa.me/393500632527" target="_blank" rel="noopener noreferrer" className="group flex items-center gap-5 text-primary-foreground/70 hover:text-[#25D366] transition-all">
                  ...
                  <div className="flex flex-col">
                    <span className="text-[10px] uppercase tracking-widest font-bold opacity-50">WhatsApp</span>
                    <span className="text-xl font-bold tracking-tight">Messaggio Istantaneo</span>
                  </div>
                </a>
              </div>
            </div>
